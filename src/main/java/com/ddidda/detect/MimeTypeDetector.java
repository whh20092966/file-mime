...
import com.ddidda.detect.universalchardet.UniversalDetector;
...
public class MimeTypeDetector {
	 ...
	 *
	 * <p>
	 * getBytes() is a {@link Callable} because it may or
	 ...
	 * value is unpadded. (Use {@link Arrays#copyOf(byte[],int)} to truncate
	 ...
	 * contents. And {@link InputStream#markSupported()} must return
